...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton->setGeometry(QRect(20, 500, 251, 31));
        pushButton_2 = new QPushButton(centralwidget);
        pushButton_2->setObjectName(QString::fromUtf8("pushButton_2"));
        pushButton_2->setGeometry(QRect(490, 500, 261, 31));
        myLabel = new QLabel(centralwidget);
        myLabel->setObjectName(QString::fromUtf8("myLabel"));
        myLabel->setGeometry(QRect(20, 10, 721, 471));
        disp = new QLabel(centralwidget);
        disp->setObjectName(QString::fromUtf8("disp"));
        disp->setGeometry(QRect(310, 510, 121, 21));
